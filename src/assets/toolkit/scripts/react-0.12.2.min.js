...
function warnAndMonitorForKeyUse(warningID, message, component, parentType) {
  ...
  message += ' See https://fb.me/react-warning-keys for more information.';
...
function warnForLegacyFactoryCall() {
  ...
  ("production" !== "development" ? warning(
    ...
    'Use a factory or JSX instead. See: https://fb.me/react-legacyfactory'
  ) : null);
      ...
      if ("production" !== "development") {
        if (!didWarn) {
          ...
          ("production" !== "development" ? warning(
            ...
            'See https://fb.me/react-transferpropsto for more information.'
          ) : null);
        }
      }
