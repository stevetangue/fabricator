...
const config = {
  ...
  fonts: {
      ...
      watch: './node_modules/bootstrap-sass/assets/fonts/bootstrap/*',
	},  
  },
  images: {
    toolkit: {
...
gulp.task('rc-scss', () => {
   return gulp.src('src/assets/toolkit/styles/**/*')
      .pipe(gulp.dest('ui-toolkit-sass'));
});

gulp.task('rc-js', () => {
   return gulp.src('src/assets/toolkit/js/**/*')
      .pipe(gulp.dest('ui-toolkit-js'));
});
